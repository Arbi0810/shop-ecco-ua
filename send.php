...
/*****************************************************/
/**/
header('Location: form-ok.html?name=' . $_REQUEST['name'] . '&phone=' . $_REQUEST['phone']. '&comment=' . $_REQUEST['title']. '&utm_source=' . $_REQUEST['utm_source']. '&utm_medium=' . $_REQUEST['utm_medium']. '&utm_campaign=' . $_REQUEST['utm_campaign']. '&utm_term=' . $_REQUEST['utm_term']. '&utm_content=' . $_REQUEST['utm_content']);
